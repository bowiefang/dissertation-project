...
parser.add_argument('--cfg', type=str, default="/home/cidi/work/work/AlphaPose/configs/coco/resnet/256x192_res50_lr1e-3_1x.yaml",
                    help='experiment configure file name')
parser.add_argument('--checkpoint', type=str, default="/home/cidi/work/work/AlphaPose/pretrained_models/fast_res50_256x192.pth",
...
parser.add_argument('--indir', dest='inputpath',
                    help='image-directory', default="")#/home/cidi/work/work/AlphaPose/examples/demo/
parser.add_argument('--list', dest='inputlist',
                    help='image-list', default="")
parser.add_argument('--image', dest='inputimg',
                    help='image-name', default="")
parser.add_argument('--outdir', dest='outputpath',
                    help='output-directory', default="/home/cidi/work/work/AlphaPose/examples/res/")
...
parser.add_argument('--video', dest='video',
                    help='video-name', default="/home/cidi/work/work/AlphaPose/examples/video/669-60084.avi")
...
if __name__ == "__main__":
    ...
    try:
        ...
        writer.stop()
        position_results = np.array(writer.position_results)
        position_results = position_results.reshape(position_results.shape[0], -1)
        fmt = ""
        for k in range(len(cfg.index_list)):
            if (k + 1) < len(cfg.index_list):
                fmt += "%.2f %d %d "
            else:
                fmt += "%.2f %d %d"
        np.savetxt('position_results.txt', position_results, fmt=fmt)
        det_loader.stop()
