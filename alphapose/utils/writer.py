    ...
    def update(self):
        ...
        while True:
            ...
            if boxes is None or len(boxes) == 0:
                ...
                keypoints_t = result['result'][0]["keypoints"]
                kp_score_t = result['result'][0]["kp_score"]
                pos_result = []
                for idx in self.cfg.index_list:
                    pos_result.append([kp_score_t[idx].item(), keypoints_t[idx][0].item(), keypoints_t[idx][1].item()])
                    self.position_results.append(pos_result)
